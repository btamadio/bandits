...
* [`src/cljs/bandits/`](src/cljs/bandits/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bandits/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `bandits` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/bandits/config.cljs) defaults to `true` in
...
```clj
(ns bandits.example
  (:require [bandits.config :as config])
